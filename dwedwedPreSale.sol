...
contract dwedwedPreSale {
    dwedwed public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 300000;
    uint constant public minSaleAmount = 30000000000000;

    function dwedwedPreSale(
        dwedwed _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = dwedwed(_token);
